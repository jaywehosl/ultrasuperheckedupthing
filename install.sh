...
T_EN[p_method1]="Reverse-proxy Nginx on domains";          T_RU[p_method1]="Реверс-прокси/Nginx с доступом по доменам"
T_EN[p_method2]="Legacy 3x-ui installation with IP address access"; T_RU[p_method2]="Устаревшая установка 3x-ui с доступом по айпи адресу"
